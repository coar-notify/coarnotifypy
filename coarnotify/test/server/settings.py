"""Settings for the COAR Notify server."""
...
RESPONSE_STATUS = 201
"""HTTP Response to provide to any incoming reqeusts.

201 and 202 are the specification compliant values
"""
...
DEBUG_PYCHARM = False
"""Put the app into PyCharm debug mode.

This turns off ``DEBUG`` and starts the PyCharm debugger.  You can set this here, or you can start the test server with
the ``-d`` option
"""
