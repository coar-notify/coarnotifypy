"""Fixtures for Announce Review Activity Streams 2.0 objects."""
...
class AnnounceReviewFixtureFactory(BaseFixtureFactory):
    """Announce Review fixture factory."""
...
ANNOUNCE_REVIEW = {
    ...
    "actor": {"id": "https://review-service.com", "name": "Review Service", "type": "Service"},
    "context": {"id": "https://research-organisation.org/repository/preprint/201203/421/"},
